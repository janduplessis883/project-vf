...
from vf.interface.apptext import *

st.set_page_config(page_title="INForecast", layout="wide")
...
if data is not None:
    with col1:
        ...
        slider_dates = start_end_date_slider(filtered_data)
        # Create a date range slider
        selected_date_range = st.slider(
            "Select a date range",
            min_value=slider_dates[0],
            max_value=slider_dates[1],
            value=(slider_dates[0], slider_dates[1]),  # Set default range
        )
